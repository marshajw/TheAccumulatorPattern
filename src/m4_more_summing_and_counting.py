...
def run_test_factorial():
    ...
    # Test 4:
    answer_from_oracle = math.factorial(111)
    answer_from_my_code = factorial(111)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 8
    answer = count_cosines_from(6, 36, 0.69)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 0
    answer = count_cosines_from(2, 4, 0.19)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 17
    answer = count_cosines_from(17, 54, 0.17)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 365
    answer = count_cosines_from(0, 900, 0.30)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 6
    answer = count_cosines_from(5, 25, 0.75)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 1.766034  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(17, 96)
